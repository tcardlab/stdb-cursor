...
export class User extends IDatabaseTable
{
	...
	constructor(identity: Identity, online: boolean) {
	super();
	...
	public static serialize(value: User): object {
		return [
		Array.from(value.identity.toUint8Array()), value.online
		];
	}
	...
	public static fromValue(value: AlgebraicValue): User
	{
		...
		let __online = productValue.elements[1].asBoolean();
		return new this(__identity, __online);
	}
